...
from app.generated.messages_pb2 import (ConvertTaskResponse, ErrorTaskResponse,
                                        MessageConvertTask, WrapperResponse)
...
def download_convert_upload(
    task_id: str, file_url: str, tmpdir: str
) -> tuple[str, float]:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            callback_data = WrapperResponse(
                ...
                convert=ConvertTaskResponse(
                    audio_len=duration, converted_file_url=s3_url
                ),
            )
